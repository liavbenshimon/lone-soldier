...
import { createUser, loginUser, getUserByFullName, getAllUsers, deleteUser, editUser, getUserByPIN } from '../controllers/userController.js';
...
router.get('/pin/:personalIdentificationNumber', authenticateToken, getUserByPIN); // Get user by personal identification number
