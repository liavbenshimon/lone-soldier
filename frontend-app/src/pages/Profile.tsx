...
const Profile: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col items-center py-10 px-4">
      <h1 className="text-3xl font-bold mb-6"><span className="text-pink-500">Profile</span> Settings</h1>
      ...
      <div className="w-full max-w-4xl bg-gray-800 p-6 rounded-lg shadow-md">
        <div className="flex">
          ...
          <div className="flex-none flex flex-col items-center mt-12">
            <img
              src={profileImage}
              alt="Profile"
              onClick={() => setIsDialogOpen(true)}
              className="w-40 h-40 rounded-full cursor-pointer border-2 hover:border-green-500"
            />
            <p className="text-sm mt-2">Change profile picture</p>
          </div>
        </div>
