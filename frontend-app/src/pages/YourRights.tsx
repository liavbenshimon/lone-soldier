    ...
    <div className="flex bg-gray-900 text-gray-100 min-h-screen">
      ...
      <div className="flex-1 flex flex-col items-center py-10 px-4">
        ...
        <div className="mt-12 text-center text-sm text-gray-500 max-w-2xl border-t border-gray-700 pt-4">
          <p>
            <strong>Disclaimer:</strong> While we strive to provide accurate and
            updated information, we cannot guarantee the rights listed here are
            the most current. Please refer to the official IDF website for the
            latest information:{" "}
            <a
